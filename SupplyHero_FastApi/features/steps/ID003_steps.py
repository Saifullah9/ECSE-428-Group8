...
def step_impl(context, email, password):
    ...
    context.response_register = context.test_client.post(
        "/register", json=context.register)
...
def step_impl(context, email, password):
    ...
    context.response_login = context.test_client.post(
...
def step_impl(context, email, password):
    context.data = jwt.decode(context.access_token, SECRET, algorithms=[
    ...
    verified, __ = fastapi_users.password.verify_and_update_password(
        password, found_hashed_pass)
